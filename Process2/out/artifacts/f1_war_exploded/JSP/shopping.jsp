...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/comm/jquery-2.1.4.js"></script>
...
<div class="topper">
    ...
    <div class="right">
        <a class="iconbounce login" href="login.jsp" title="登录 / 注册"><i class="icon icon-login"></i>登录 / 注册</a>
...
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/js/slick.min.js"></script>--%>
    ...
    <table  class="B2" style="margin: 0 auto 0">
        ...
        <tr colspan="4">
            <td>
                <img src="${pageContext.request.contextPath}/${product.picture}" width="300px" height="400px">
            </td>
            <td>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td style="line-height: 300%">
                ...
                <div class="shop-specs">
                    ...
                    <div class="shop-but">
                        ...
                        <a onclick="buy()" class="buy cartBuy" href="javascript:;" data-url="//www.haohua.com/shop/cart/buy/product/{id}/num/{num}/">立即购买</a>
...
<div class="wrap">
    ...
    <div class="body-box yhpj">
                        ...
                        <div class="bbs-con">
                            ...
                            <div class="bbs-img">
                                <ul class="clearfix">
                                    ...
                                    <li><img src="${pageContext.request.contextPath}/${remark.remark_src}" jqimg="#" width="200" /></li>
                                    </c:if>
                                </ul>
        ...
        <%--<script language="javascript" src="/click/content/aid/45746/"></script>--%>
    </div>
</div>
<div class="footer">
...
<script type="text/javascript">
    function buy() {
        location.href="${pageContext.request.contextPath}/shopAction?method=buy&id=${product.goodid}&number="+$("#numbernu").val();
    }
    function shopcar() {
